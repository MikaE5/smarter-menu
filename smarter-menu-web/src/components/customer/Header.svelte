    ...
    <Collapse {isOpen} navbar>
      <Nav navbar justified>
        {#each navItems as navItem}
          <div
            class="d-flex justify-content-center w-100 p-1 nav-item-text"
        ...
        {/each}
        <div
          class="d-flex justify-content-center w-100 p-1 border-top nav-item-bookmarks"
          on:click={() => navigateTo('bookmarks')}
        >
          {$pageConfigStore.page_content.bookmarks.to_bookmarks}
        </div>
      </Nav>
    </Collapse>
  </Navbar>
