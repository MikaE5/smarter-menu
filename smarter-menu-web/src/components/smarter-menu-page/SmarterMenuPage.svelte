...
<div class="is-preload">
  ...
  <div id="wrapper" class="divided">
    <!-- Top -->
    <section
      class="banner style4 orient-center content-align-left image-position-left fullscreen onload-image-fade-in onload-content-fade-right color1"
    >
      <div class="content">
        <h1>smarter-menu</h1>
        <p class="major">
          <b>Einfach. Hygienisch. Günstig.</b><br />
          <i>Für anschauliche und digitalisierte Speise- & Getränkekarten.</i>
        </p>
        <ul class="actions stacked">
          <li><a href="#process" class="button">Erfahre mehr</a></li>
        </ul>
        <ul class="actions stacked">
          <li>
            <!-- <Link to={getBaseCustomerPath('adobo')} class="button big wide"
              >Schau Dir ein Kundenbeispiel an</Link
            > -->
            <a href="/menu/adobo" class="button"
              >Schau Dir ein Kundenbeispiel an</a
            >
          </li>
        </ul>
      </div>
    ...
    <!-- process -->
    <section class="wrapper style1 align-center" id="process">
      <div class="inner">
        <h2>Ablauf</h2>
        <p>
          Aktuell bildet smarter-menu den Bestellprozess vom "digitalen
          austeilen" der Menükarte bis zur persönlichen Bestellung mithilfe der
          Bedienung ab. Bestellungen und Bezahlungen direkt über smarter-menu.de
      ...
      <div class="gallery style2 medium lightbox onscroll-fade-in">
        <article>
          <img src="images/gallery/thumbs/Step1.png" alt="" />
          <div class="caption">
            <p>
              QR-codes sollten bestenfalls ausreichend viele und wasserfest
              sichtbar auf Tischen angebracht werden.
            </p>
          </div>
        </article>
        <article>
          <img src="images/gallery/thumbs/Step2.png" alt="" />
          <div class="caption">
            <p>
              Der QR-code kann bequem mit dem Smartphone gescannt werden, um die
              Menükarte im Browser zu öffnen.
            </p>
          </div>
        </article>
        <article>
          <img src="images/gallery/thumbs/Step3.png" alt="" />
          <div class="caption">
            <p>
              Man kann entspannt durch die Menükarte stöbern und die Auswahl per
              "+" auf die Merkliste setzen.
            </p>
          </div>
        </article>
        <article>
          <img src="images/gallery/thumbs/Step4.png" alt="" />
          <div class="caption">
            <p>
              Sobald die Bedienung das nächste mal kommt, kann die jeweilige
              Auswahl - festgehalten auf der Merkliste - mitgeteilt werden.
            </p>
          </div>
        </article>
      </div>
    ...
    <!-- benefits -->
    <section class="wrapper style1 align-center" id="benefits">
      <div class="inner">
        <h2>Welche Vorteile smarter-menu mit sich bringt</h2>
        <div class="items style1 medium onscroll-fade-in">
          <section>
            <span class="icon style2 major fa-gem" />
            <h3>Einfach</h3>
            <p>
              Ganz klar wird darauf abgezielt simpel zu sein und mit Absicht
              wird auf jeglichen Schnick-Schnack verzichtet.
            </p>
          </section>
          <section>
            ...
            <h3>Hygienisch</h3>
            <p>
              Schluss mit dreckigen oder zerfransten Menükarten und willkommen
          ...
          <section>
            ...
            <h3>Günstig</h3>
            <p>
              Mit lediglich 10€ pro Monat ist smarter-menu deutlich günstiger
              als alternative Lösungen gleicher Qualität.
            </p>
          </section>
          <section>
            ...
            <h3>Anschaulich</h3>
            <p>
              Die Menükarten sind für Handyansichten optimiert, damit man sich
              schnell zurechtfindet und sich nicht in einer PDF oder auf einer
              fremden Website herumirren muss.
            </p>
          </section>
          <section>
            ...
            <h3>Zeitsparend</h3>
            <p>
              Im Zeitalter des Fachkräftemangels im Gastgewerbe spart eine
              digitale Menükarte Zeit und Geld, da der initiale Weg zum
              Austeilen der Karten entfällt.
            </p>
          </section>
          <section>
            ...
            <h3>inkl. CMS</h3>
            <p>
              Falls sich Preise auf der Menükarte ändern sollten, neue Produkte
              dazukommen oder etwas ausverkauft ist, kann man die Karte schnell
              und einfach über ein eigenes "Content-Management-System" (CMS)
              anpassen.
            </p>
          </section>
          <section>
            ...
            <h3>KVP</h3>
            <p>
              Im Sinne vom "Kontinuierlichen Verbesserungsprozess" (KVP) wird
              ständig an smarter-menu gearbeitet, sodass neue Funktionen zeitnah
              hinzukommen werden.
            </p>
          </section>
          <section>
            <span class="icon solid style2 major fa-paper-plane" />
            <h3>Support</h3>
            <p>
              Falls etwas nicht funktionieren sollte (was selten der Fall ist),
              ist ein Kundenservice unkompliziert erreichbar.
            </p>
          </section>
          <section>
            ...
            <h3>Agil</h3>
            <p>
              Unser kleines Team ist für Verbesserungsvorschläge jederzeit offen
              und gerne arbeiten wir auch gemeinsam mit Dir an neuen Lösungen.
            </p>
          </section>
        </div>
      </div>
    ...
    <!-- price -->
    <section class="wrapper style2 align-center color3" id="price">
      <div class="inner">
        <h2>Preis</h2>
        <p>
          Die Kosten für eine digitale Menükarte von smarter-menu liegen gerade
          einmal bei <b>nur 10€ pro Monat</b> und somit deutlich günstiger als vergleichbare
          Angebote.
        </p>
    ...
    <!-- contact -->
    <section class="wrapper style2 align-center" id="contact">
      <div class="inner">
        <div class="index align-left">
          <section>
            <header>
            ...
            <div class="content">
              <blockquote>
                Kontaktiere uns ganz einfach per Mail an: <a
                  href="mailto:info@smarter-menu.de">info@smarter-menu.de</a
                >
                und vereinbare ein Telefontermin oder frage uns, was immer du wissen
                möchtest. <br /><br />
                Auch über Feedback oder sonstige Anmerkungen freuen wir uns sehr.
              </blockquote>
            </div>
          </section>
        </div>
    ...
    <!-- Footer -->
    <footer class="wrapper style1 align-center color3">
      <div class="inner">
        <a href="/imprint" class="button fit small">Impressum</a>
        <a href="/privacy" class="button fit small">Datenschutz</a>

        <!--   <Link class="button fit small" to="/imprint">Impressum</Link>
        <Link class="button fit small" to="/privacy">Datenschutz</Link> -->
        <br />
        <br />
        <br />
        <br />
...
*/
  ...
  *:after {
  ...
  .icon {
    ...
    position: relative;
    text-align: center;
    color: var(--smarter-menu-dark-accent);
  }
